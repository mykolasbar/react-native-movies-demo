...
<ul>
    ...
    <li>A detailed info page for each film, which can be accessed from all category lists, which features:
        <ul>
    ...
    <li>A search screen, allowing the user to search the film by title or part of title.</li>
